...
# jesse123 default password
sed -i "s|sed -i 's/root::0:0:99999:7:::/root:$1$V4UetPzk$CYXluq4wUazHjmCDBCqXF.:0:0:99999:7:::/g' /etc/shadow|sed -i 's/root::0:0:99999:7:::/root:$1$ftfdef9C$jCP8YGq7NZCqxI8JMk.Um0:0:0:99999:7:::/g' /etc/shadow|g" package/emortal/default-settings/files/99-default-settings
